...
#line 0 "/Users/ex3ndr/Develop/actor-proprietary/actor-sdk/sdk-core/runtime/runtime-shared/src/main/java//org/bouncycastle/util/Arrays.java"
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "init", "Arrays", NULL, 0x2, NULL, NULL },
    { "areEqualWithBooleanArray:withBooleanArray:", "areEqual", "Z", 0x9, NULL, NULL },
    { "areEqualWithCharArray:withCharArray:", "areEqual", "Z", 0x9, NULL, NULL },
    { "areEqualWithByteArray:withByteArray:", "areEqual", "Z", 0x9, NULL, NULL },
    { "constantTimeAreEqualWithByteArray:withByteArray:", "constantTimeAreEqual", "Z", 0x9, NULL, NULL },
    { "areEqualWithIntArray:withIntArray:", "areEqual", "Z", 0x9, NULL, NULL },
    { "areEqualWithLongArray:withLongArray:", "areEqual", "Z", 0x9, NULL, NULL },
    { "areEqualWithNSObjectArray:withNSObjectArray:", "areEqual", "Z", 0x9, NULL, NULL },
    { "containsWithShortArray:withShort:", "contains", "Z", 0x9, NULL, NULL },
    { "containsWithIntArray:withInt:", "contains", "Z", 0x9, NULL, NULL },
    { "fillWithByteArray:withByte:", "fill", "V", 0x9, NULL, NULL },
    { "fillWithCharArray:withChar:", "fill", "V", 0x9, NULL, NULL },
    { "fillWithLongArray:withLong:", "fill", "V", 0x9, NULL, NULL },
    { "fillWithShortArray:withShort:", "fill", "V", 0x9, NULL, NULL },
    { "fillWithIntArray:withInt:", "fill", "V", 0x9, NULL, NULL },
    { "hashCodeWithByteArray:", "hashCode", "I", 0x9, NULL, NULL },
    { "hashCodeWithByteArray:withInt:withInt:", "hashCode", "I", 0x9, NULL, NULL },
    { "hashCodeWithCharArray:", "hashCode", "I", 0x9, NULL, NULL },
    { "hashCodeWithIntArray2:", "hashCode", "I", 0x9, NULL, NULL },
    { "hashCodeWithIntArray:", "hashCode", "I", 0x9, NULL, NULL },
    { "hashCodeWithIntArray:withInt:withInt:", "hashCode", "I", 0x9, NULL, NULL },
    { "hashCodeWithShortArray3:", "hashCode", "I", 0x9, NULL, NULL },
    { "hashCodeWithShortArray2:", "hashCode", "I", 0x9, NULL, NULL },
    { "hashCodeWithShortArray:", "hashCode", "I", 0x9, NULL, NULL },
    { "hashCodeWithNSObjectArray:", "hashCode", "I", 0x9, NULL, NULL },
    { "cloneWithByteArray:", "clone", "[B", 0x9, NULL, NULL },
    { "cloneWithByteArray:withByteArray:", "clone", "[B", 0x9, NULL, NULL },
    { "cloneWithByteArray2:", "clone", "[[B", 0x9, NULL, NULL },
    { "cloneWithByteArray3:", "clone", "[[[B", 0x9, NULL, NULL },
    { "cloneWithIntArray:", "clone", "[I", 0x9, NULL, NULL },
    { "cloneWithLongArray:", "clone", "[J", 0x9, NULL, NULL },
    { "cloneWithLongArray:withLongArray:", "clone", "[J", 0x9, NULL, NULL },
    { "cloneWithShortArray:", "clone", "[S", 0x9, NULL, NULL },
    { "cloneWithJavaMathBigIntegerArray:", "clone", "[Ljava.math.BigInteger;", 0x9, NULL, NULL },
    { "copyOfWithByteArray:withInt:", "copyOf", "[B", 0x9, NULL, NULL },
    { "copyOfWithCharArray:withInt:", "copyOf", "[C", 0x9, NULL, NULL },
    { "copyOfWithIntArray:withInt:", "copyOf", "[I", 0x9, NULL, NULL },
    { "copyOfWithLongArray:withInt:", "copyOf", "[J", 0x9, NULL, NULL },
    { "copyOfWithJavaMathBigIntegerArray:withInt:", "copyOf", "[Ljava.math.BigInteger;", 0x9, NULL, NULL },
    { "copyOfRangeWithByteArray:withInt:withInt:", "copyOfRange", "[B", 0x9, NULL, NULL },
    { "copyOfRangeWithIntArray:withInt:withInt:", "copyOfRange", "[I", 0x9, NULL, NULL },
    { "copyOfRangeWithLongArray:withInt:withInt:", "copyOfRange", "[J", 0x9, NULL, NULL },
    { "copyOfRangeWithJavaMathBigIntegerArray:withInt:withInt:", "copyOfRange", "[Ljava.math.BigInteger;", 0x9, NULL, NULL },
    { "getLengthWithInt:withInt:", "getLength", "I", 0xa, NULL, NULL },
    { "appendWithByteArray:withByte:", "append", "[B", 0x9, NULL, NULL },
    { "appendWithShortArray:withShort:", "append", "[S", 0x9, NULL, NULL },
    { "appendWithIntArray:withInt:", "append", "[I", 0x9, NULL, NULL },
    { "concatenateWithByteArray:withByteArray:", "concatenate", "[B", 0x9, NULL, NULL },
    { "concatenateWithByteArray:withByteArray:withByteArray:", "concatenate", "[B", 0x9, NULL, NULL },
    { "concatenateWithByteArray:withByteArray:withByteArray:withByteArray:", "concatenate", "[B", 0x9, NULL, NULL },
    { "concatenateWithIntArray:withIntArray:", "concatenate", "[I", 0x9, NULL, NULL },
    { "prependWithByteArray:withByte:", "prepend", "[B", 0x9, NULL, NULL },
    { "prependWithShortArray:withShort:", "prepend", "[S", 0x9, NULL, NULL },
    { "prependWithIntArray:withInt:", "prepend", "[I", 0x9, NULL, NULL },
    { "reverseWithByteArray:", "reverse", "[B", 0x9, NULL, NULL },
  };
  static const J2ObjcClassInfo _OrgBouncycastleUtilArrays = { 2, "Arrays", "org.bouncycastle.util", NULL, 0x11, 55, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
